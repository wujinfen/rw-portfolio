...
import BD_Card from "@/components/work-experiences/BD_card"
  ...
  return (
    ...
    <main className="bg-gradient-to-b from-zshade to-dneutral overflow-x-hidden">
      ...
      >
        ...
        {/* EXPERIENCE SECTION */}
        <section className="mx-auto max-w-screen-md pb-12">
          <div className="flex flex-col md:flex-row gap-1 md:gap-6 lg:gap-8 mx-auto">
            ...
            <div className="flex flex-col gap-4 ml-10 mr-8 md:mr-16 lg:ml-0 lg:mr-124 w-full ">
              ...
              <section className="hover:shadow-xl hover:mt-4 hover:mb-4 transition-all transform hover:scale-105 duration-300 rounded-md mr-76 md:mr-14 lg:mr-0 lg:ml-0">
                <BD_Card />
              </section>
        ...
        <section className="mx-auto max-w-screen-md">
          <div className="flex flex-col md:flex-row gap-1 md:gap-6 lg:gap-8 mx-auto">
            ...
            <div className="flex flex-col gap-4 ml-10 mr-8 md:mr-16 lg:ml-0 lg:mr-124 w-full ">
              ...
              <section className="hover:shadow-xl hover:mt-4 hover:mb-4 transition-all transform hover:scale-105 duration-300 rounded-md mr-76 md:mr-14 lg:mr-0 lg:ml-6">
                <MeddayCard />
              </section>
